        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                         <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('place.update', $place->place_id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

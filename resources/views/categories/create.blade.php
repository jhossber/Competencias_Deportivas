        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="{{ route('category.store') }}" class="form-horizontal form-label-left" data-parsley-validate="" id="demo-form2" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            ...
                                            <input class="form-control" name="group" placeholder="Introduzca un grupo" type="text">
                                            </input>

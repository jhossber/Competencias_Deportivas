  ...
  <div class="left_col scroll-view">
    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        ...
        @endcan
          <li><a><i class="fa fa-user"></i> Gestionar Equipos <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
            @can('player.index')
              <li><a href="{{ route('player.index') }}">Plantel de Jugaodores</a></li>
            @endcan
              <li><a href="{{ route('team.index') }}">Equipos</a></li>
